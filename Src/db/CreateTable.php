...
public static function createTable($records, $titles): String
{
$input_1 = self::createTableHead($records, $titles);
...
public static function createTableHead($records, $titles): String
{
